...
# script constants
BUILD_THREAD_COUNT=${BUILD_THREAD_COUNT:-16}
OVERRIDE_PYTHON3_CMD=${OVERRIDE_PYTHON3_CMD:-"Y"}
PYTHON_SOURCE_VERSION=${PYTHON_SOURCE_VERSION:-"3.8.6"}
PYTHON_BUILD_DIR=${PYTHON_BUILD_DIR:-$(pwd)/python}
